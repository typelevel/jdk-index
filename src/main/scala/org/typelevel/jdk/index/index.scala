...
val MainIndex: Index = Index(
  List(
    ...
    Release(Linux, Amd64, OpenJ9JDK11, Version("0.27"), TarGZ, url("https://github.com/ibmruntimes/semeru11-binaries/releases/download/jdk-11.0.12%2B7_openj9-0.27.0/ibm-semeru-open-jdk_x64_linux_11.0.12_7_openj9-0.27.0.tar.gz")),
    Release(Linux, Amd64, OpenJ9JDK8, Version("0.27"), TarGZ, url("https://github.com/ibmruntimes/semeru8-binaries/releases/download/jdk8u302-b08_openj9-0.27.0/ibm-semeru-open-jdk_x64_linux_8u302b08_openj9-0.27.0.tar.gz")),
    ...
    Release(Windows, Amd64, OpenJ9JDK11, Version("0.27"), Zip, url("https://github.com/ibmruntimes/semeru11-binaries/releases/download/jdk-11.0.12%2B7_openj9-0.27.0/ibm-semeru-open-jdk_x64_windows_11.0.12_7_openj9-0.27.0.zip")),
    Release(Windows, Amd64, OpenJ9JDK8, Version("0.27"), Zip, url("https://github.com/ibmruntimes/semeru8-binaries/releases/download/jdk8u302-b08_openj9-0.27.0/ibm-semeru-open-jdk_x64_windows_8u302b08_openj9-0.27.0.zip")),
  )
)
// format: on
