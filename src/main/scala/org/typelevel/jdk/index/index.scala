...
val MainIndex: Index = Index(
  List(
    ...
    Release(Linux, Amd64, Corretto, JDK_8, TarGZ, url("https://corretto.aws/downloads/latest/amazon-corretto-8-x64-linux-jdk.tar.gz")),
    Release(Linux, Amd64, Oracle, JDK_17, TarGZ, url("https://download.oracle.com/java/17/latest/jdk-17_linux-x64_bin.tar.gz")),
    ...
    Release(Linux, Aarch64, Corretto, JDK_8, TarGZ, url("https://corretto.aws/downloads/latest/amazon-corretto-8-aarch64-linux-jdk.tar.gz")),
    Release(Linux, Aarch64, Oracle, JDK_17, TarGZ, url("https://download.oracle.com/java/17/latest/jdk-17_linux-aarch64_bin.tar.gz")),
    ...
    Release(MacOS, Amd64, Corretto, JDK_8, TarGZ, url("https://corretto.aws/downloads/latest/amazon-corretto-8-x64-macos-jdk.tar.gz")),
    Release(MacOS, Amd64, Oracle, JDK_17, TarGZ, url("https://download.oracle.com/java/17/latest/jdk-17_macos-x64_bin.tar.gz")),
    ...
    Release(MacOS, Arm64, Oracle, JDK_17, TarGZ, url("https://download.oracle.com/java/17/latest/jdk-17_macos-aarch64_bin.tar.gz")),
    ...
    Release(Windows, Amd64, Corretto, JDK_8, Zip, url("https://corretto.aws/downloads/latest/amazon-corretto-8-x64-windows-jdk.zip")),
    Release(Windows, Amd64, Oracle, JDK_17, Zip, url("https://download.oracle.com/java/17/latest/jdk-17_windows-x64_bin.zip"))
  )
)
// format: on
